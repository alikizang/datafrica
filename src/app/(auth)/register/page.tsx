      ...
      <div className="w-full max-w-md">
        <div className="glass-card rounded-2xl p-8 space-y-6">
          <div className="text-center space-y-3">
            <div className="h-14 w-14 mx-auto rounded-xl bg-gradient-to-br from-primary to-[#6c5ce7] flex items-center justify-center">
              <span className="text-white font-bold text-xl">D</span>
            </div>
            <h1 className="text-2xl font-bold text-foreground">{t("auth.createAccount")}</h1>
            <p className="text-sm text-muted-foreground">{t("auth.joinDesc")}</p>
          </div>

          {/* Google Sign-In */}
          <button
            onClick={handleGoogle}
            className="w-full h-12 rounded-xl border border-border text-foreground font-medium hover:bg-muted transition-colors flex items-center justify-center gap-3"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-secondary-foreground">{t("auth.fullName")}</label>
              <Input
                type="text"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-secondary-foreground">{t("auth.email")}</label>
              <Input
                type="email"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-secondary-foreground">{t("auth.password")}</label>
              <div className="relative">
                <Input
                  ...
                  required
                  minLength={6}
                  className="h-12 bg-muted border-border text-foreground placeholder:text-dim rounded-xl focus:border-primary pr-11"
                />
                <button
                  type="button"
